 ...
 * Class Servises
 *
 * @property \App\Servises $model
 *
 * @see http://sleepingowladmin.ru/docs/model_configuration_section
 */
class Servises extends Section implements Initializable
{
    /**
    ...
    public function onDisplay()
    {
        ...
        ->setHtmlAttribute('class', 'table-primary')
            ->setColumns(
                ...
                AdminColumn::link('title', 'Название услуги')->setWidth('300px'),
    ...
    public function onEdit($id)
    {
        ...
        return AdminForm::panel()->addBody([
            AdminFormElement::text('ref', 'Ссылка'),
            ...
            ->addBody([
                AdminFormElement::text('section', 'Раздел'),
